...
(() => {
    ...
    const languages = document.querySelectorAll('input[name="language"]'), extensions = [...document.querySelectorAll('input[type="checkbox"]')], indent = document.querySelector('#indent'), mediawikiOnly = ['escape', 'tagMatching', 'refHover', 'openExtLinks'], cm = new CodeMirror6(textarea), linters = {};
