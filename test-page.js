...
(async () => {
    const tests = await (await fetch('./test/parserTests.json')).json(), select = document.querySelector('select'), textarea = document.querySelector('textarea'), pre = document.querySelector('pre');
