import {CodeMirror6, CDN} from 'https://testingcf.jsdelivr.net/npm/@bhsd/codemirror-mediawiki@2.2.1/dist/main.min.js';
...
const REPO_CDN = 'npm/@bhsd/codemirror-mediawiki@2.2.1';
export {CDN, REPO_CDN};
