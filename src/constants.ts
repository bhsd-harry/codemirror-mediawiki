...
export const baseData: Record<'CDN', string | undefined> = {CDN: undefined},
	...
	linkMark = /* #__PURE__ */ Decoration.mark({class: linkCls}),
	doctagMark = /* #__PURE__ */ Decoration.mark({class: doctag}),
	typeMark = /* #__PURE__ */ (() => Decoration.mark({class: `${doctag}-type`}))(),
